...
2.  **In de gekozen taal de taalbevestiging geven** en **vervolgens vragen om de casus in te dienen** (STAP 2).
...
2.  Op basis van deze analyse **autonoom** de meest geschikte en ecologisch verantwoorde formatie kiezen (**Optie 1 of Optie 2**).
3.  De **gekozen Optie bevestigen** en **een korte, duidelijke uitleg** geven waarom deze keuze is gemaakt (bijvoorbeeld: "Vanwege de hoge complexiteit en de noodzaak tot diepgaande sub-analyse, is Modus 2 verkozen.").
4.  **Onmiddellijk na de uitleg** de lancering van het panel starten (Round 1).
